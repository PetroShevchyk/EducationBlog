    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        <div class="main-left col-span-1">
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                <div class="space-y-4">
                    <div class="flex items-center justify-between" v-for="conversation in conversations" v-bind:key="conversation.id"
            ...
            <div class="bg-white border border-gray-200 rounded-lg">
                <form v-on:submit.prevent="submitForm">
                    ...
                    <div class="p-2 border-t border-gray-100 flex justify-between">
                        <button class="inline-block py-2 px-4 text-black bg-white border border-gray-200 rounded-lg hover:bg-gray-200">Send</button>
                    </div>
                </form>
            </div>
        </div>
...
export default (await import('vue')).defineComponent({
    ...
    methods: {
        ...
        submitForm() {
            ...
            axios
                .post(`/chat/${this.activeConversation.id}/send/`, {body: this.body})
                .then(response => {
                    console.log(response.data)
