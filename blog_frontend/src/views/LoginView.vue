        ...
        <div class="main-right">
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                <form class="space-y-6" v-on:submit.prevent="submitForm">
                    ...
                    <div>
                        <button class="py-2 px-4 text-black bg-white border border-gray-200 rounded-lg hover:bg-gray-200">Log in</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            if (this.errors.length === 0) {
                await axios
                    ...
                    .catch(error => {
                        ...
                        this.errors.push('The email or password was incorrect!')
                    })
            }
