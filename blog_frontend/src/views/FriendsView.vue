            ...
            >
                ...
                >
                    ...
                    <div class="mt-6 space-x-4">
                        <button class="inline-block py-2 px-4 text-white bg-emerald-600 rounded-lg hover:bg-emerald-500" @click="handleRequest('accepted', friendshipRequest.created_by.id)">Accept</button>
                        <button class="inline-block py-2 px-4 text-white bg-red-600 rounded-lg hover:bg-gray-500" @click="handleRequest('rejected', friendshipRequest.created_by.id)">Reject</button>
                    </div>
                </div>
