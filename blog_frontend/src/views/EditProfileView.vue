            ...
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                <form class="space-y-6" v-on:submit.prevent="submitForm">
                    ...
                    <div>
                        ...
                        <textarea v-model="form.info" class="p-4 w-full border border-gray-200 rounded-lg" placeholder="Enter something about yourself"></textarea>
                    </div>
                    <div>
                    ...
                    <div>
                        <button class="py-4 px-6 bg-emerald-600 text-white rounded-lg hover:bg-emerald-500">Save changes</button>
                    </div>
                </form>
            </div>
        </div>
