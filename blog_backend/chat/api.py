...
from .serializers import ConversationSerilizer, ConversationDetailSerializer, ConversationMessageSerializer
...
def conversation_send_message(request, pk):
    ...
    conversation_message = ConversationMessage.objects.create(conversation=conversation,
